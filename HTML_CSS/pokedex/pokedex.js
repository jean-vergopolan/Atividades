const classes = [
...

   {
...

    {
        ...
        card: "./assets/cardbarbaro",
        descricao: "BÁRBARO: Guerreiros tribais, nômades totêmicos, herdeiros de linhagens primitivas e protetores de terras distantes. Todos esses são bárbaros, definidos por sua fúria: uma raiva animal, impetuosa e inesgotável. Como bárbaros, eles compartilham de um vigor primordial que permite que realizem feitos de força e resistência sobre-humanas. Para um bárbaro, a fúria é um poder que concede reflexos, resiliência e força incríveis, sendo a fonte vital que os mantém lutando onde outros já teriam caído."
    },

    {
        nome: "bardo",
        gif: "./assets/bardo.gif",
        card: "./assets/cardbardo",
...
const cartinhaBotao = document.querySelectorAll('.cartinha');
cartinhaBotao.forEach((carta, index) => {
